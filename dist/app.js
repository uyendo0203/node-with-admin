...
var loadSettingsMiddleware = /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 8:
          ...
          console.error('Error fetching settings (loadSettingsMiddleware):', _context.t0);
  ...
  return function loadSettingsMiddleware(_x, _x2, _x3) {
...
// Routes
var apiBlogRoutes = require('./routes/BlogRoutes/apiBlog');
app.use('/', apiBlogRoutes); // Sử dụng blog routes api
var viewBlogRoutes = require('./routes/BlogRoutes/viewBlog');
app.use('/', viewBlogRoutes); // Sử dụng blog routes view

var apiSettingsRoutes = require('./routes/SettingsRoutes/apiSettings');
app.use('/', apiSettingsRoutes); // Sử dụng user api
var viewSettingsRoutes = require('./routes/SettingsRoutes/viewSettings');
